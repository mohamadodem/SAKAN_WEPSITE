...
<style>
    ...
    .form-group select:focus {
        ...
        background: white;
        box-shadow: 0 0 0 3px rgba(52, 152, 219, 0.1);
        background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org2000/svg' viewBox='0 0 24 24' fill='none' stroke='%233498db' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");
    }
    ...
    .form-group span:not(.form-group) {
        display: block;
        color: #e74c3c;
        font-size: 13px;
        margin-top: 8px;
